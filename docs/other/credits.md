...
Please, before submitting a PR or opening an issue, be sure to follow the [contributing guidelines](https://github.com/Matt-FTW/dotfiles/blob/main/.github/CONTRIBUTING.md), as well as the [issues](https://github.com/Matt-FTW/dotfiles/tree/main/.github/ISSUE_TEMPLATE) and [pull requests](https://github.com/Matt-FTW/dotfiles/blob/main/.github/PULL_REQUEST_TEMPLATE.md) formatting rules.
